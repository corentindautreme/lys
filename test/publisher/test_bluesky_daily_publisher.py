...
class BlueskyDailyPublisherTest(unittest.TestCase):
    ...
    def test_when_calling_daily_publisher_with_multiple_events_should_generate_and_publish_multi_post_thread(self):
        ...
        self.assertEqual(summary[0]['text'], "TODAY | 3 selection shows across Europe and Australia! (thread \U00002B07\U0000FE0F)")
        self.assertEqual(summary[1]['text'], "TODAY | \U0001F1E6\U0001F1FA AUSTRALIA\n---------\n\U0001F4FC Australia Decides\n\U0001F3C6 Final\n\U0001F553 10:30 CET\n---------\n\U0001F4FA https://facebook.com.")
        self.assertEqual(summary[2]['text'], "TODAY | \U0001F1F3\U0001F1F4 NORWAY\n---------\n\U0001F4FC Melodi Grand Prix\n\U0001F3C6 Heat 5\n\U0001F553 19:50 CET\n---------\n\U0001F4FA https://nrk.no/mgp.")
        self.assertEqual(summary[3]['text'], "TODAY | \U0001F1F8\U0001F1EA SWEDEN\n---------\n\U0001F4FC Melodifestivalen\n\U0001F3C6 Heat 2\n\U0001F553 20:00 CET\n---------\n\U0001F4FA https://svtplay.se.")
