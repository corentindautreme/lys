...
class ThreadsDailyPublisherTest(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        with patch('publisher.threads_daily_publisher.ThreadsClient', new=MockClient):
            self.publisher = ThreadsDailyPublisher()
    ...
    def test_when_calling_daily_publisher_with_one_event_should_generate_and_publish_single_post_thread(self):
        ...
        self.assertEqual(summary[0], "daily|threads")
        summary = summary[1:]
        
        ethreadspected_post = "TODAY | \U0001F1F8\U0001F1EA SWEDEN\n---------\n\U0001F4FC Melodifestivalen\n\U0001F3C6 Final\n\U0001F553 20:00 CET\n---------\n\U0001F4FA https://svtplay.se."
    ...
    def test_when_calling_daily_publisher_with_multiple_events_should_generate_and_publish_multi_post_thread(self):
        events = [
            ...
            {'country': 'Norway', 'name': 'Melodi Grand Prithreads', 'stage': 'Heat 5', 'dateTimeCet': '2021-02-13T19:50:00', 'watchLinks': [{'link': 'https://nrk.no/mgp', 'comment': 'Recommended link', 'live': 1}]},
