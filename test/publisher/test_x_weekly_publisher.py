...
class XWeeklyPublisherTest(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        with patch('publisher.x_weekly_publisher.XClient', new=MockClient):
            self.publisher = XWeeklyPublisher()
    ...
    def test_when_calling_weekly_publisher_should_generate_single_post_thread(self):
        ...
        self.assertEqual(summary[0], "weekly|twitter")
