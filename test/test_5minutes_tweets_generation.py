...
from lys_5minutes import generate_twitter_event_strings, build_twitter_posts
...
class FiveMinutesTweetsGenerationTest(unittest.TestCase):
    def test_when_events_fit_in_one_tweet_then_should_generate_one_tweet(self):
        ...
        tweets = build_twitter_posts(event_strings)
    ...
    def test_when_very_complicated_events_do_not_fit_in_one_tweet_then_should_generate_multiple_tweets(self):
        ...
        self.assertEqual(tweets[1], "\U0001F1F3\U0001F1F4 Melodi Grand Prix - Final (https://somereallyreallyreallyreallylongurl.no (Next-best link every made out there!)(geoblocked, account required: see https://lyseurovision.github.io/help.html#account-Norway))")
        self.assertEqual(tweets[2], "\U0001F1EA\U0001F1EA Eesti Laul - Final (https://somereallyreallyreallyreallylongurl.ee (Not the best link, but not the worst either!)(geoblocked, account required: see https://lyseurovision.github.io/help.html#account-Estonia))")
        self.assertEqual(tweets[3], "\U0001F1EB\U0001F1EE Uuden Musiikin Kilpailu - Final (https://somereallyreallyreallyreallylongurl.fi (That link is pretty damn good!)(geoblocked, account required: see https://lyseurovision.github.io/help.html#account-Finland))")
        self.assertEqual(tweets[4], "\U0001F1F7\U0001F1F8 Beovizija - Final (https://somereallyreallyreallyreallylongurl.rs (Super mega ultra HD 16K very good link click it!)(geoblocked, account required: see https://lyseurovision.github.io/help.html#account-Serbia))")
