...
class DailyTweetsGenerationTest(unittest.TestCase):
    ...
    def test_when_2_events_then_should_generate_3_tweets(self):
        ...
        self.assertTrue(tweets[1] == "TODAY: \U0001F1F8\U0001F1EA Sweden | Melodifestivalen - Final at 20:00 CET. Watch live: https://svtplay.se")
        self.assertTrue(tweets[2] == "TODAY: \U0001F1E9\U0001F1F0 Denmark | Dansk Melodi Grand Prix - Final at 20:00 CET. Watch live: https://tv.dr.dk")
    ...
    def test_when_multiple_events_and_1_Australian_event_then_should_mention_Australia_in_first_tweet(self):
        ...
        self.assertTrue(tweets[1] == "TODAY: \U0001F1F8\U0001F1EA Sweden | Melodifestivalen - Heat 2 at 20:00 CET. Watch live: https://svtplay.se")
        self.assertTrue(tweets[2] == "TODAY: \U0001F1E6\U0001F1FA Australia | Australia Decides - Final at 10:30 CET. Watch live: https://facebook.com")
        self.assertTrue(tweets[3] == "TODAY: \U0001F1F3\U0001F1F4 Norway | Melodi Grand Prix - Heat 5 at 19:50 CET. Watch live: https://nrk.no/mgp")