...
class DailyTweetsGenerationTest(unittest.TestCase):
    ...
    def test_when_one_event_contains_geoblocked_watch_links_should_add_geoblocked_comment_to_tweet(self):
        ...
        tweets = generate_daily_tweet_thread(events, is_morning=True)
        self.assertEqual(len(tweets), 1)
        self.assertEqual(tweets[0], "TODAY | \U0001F1F3\U0001F1F4 NORWAY\n---------\n\U0001F4FC Melodi Grand Prix\n\U0001F3C6 Final\n\U0001F553 19:50 CET\n---------\n\U0001F4FA https://nrk.no/mgp OR https://tv.nrk.no (geoblocked).")
    ...
    def test_when_one_event_contains_watch_link_that_requires_an_account_should_add_comment_to_tweet(self):
        ...
        tweets = generate_daily_tweet_thread(events, is_morning=True)
        self.assertEqual(len(tweets), 1)
        self.assertEqual(tweets[0], "TODAY | \U0001F1F3\U0001F1F4 NORWAY\n---------\n\U0001F4FC Melodi Grand Prix\n\U0001F3C6 Final\n\U0001F553 19:50 CET\n---------\n\U0001F4FA https://nrk.no/mgp OR https://tv.nrk.no (account required: https://lyseurovision.github.io/help.html#account-Norway).")
    ...
    def test_when_one_event_contains_watch_link_that_requires_an_account_and_is_geoblocked_should_add_comment_to_tweet(self):
        ...
        tweets = generate_daily_tweet_thread(events, is_morning=True)
        self.assertEqual(len(tweets), 1)
        self.assertEqual(tweets[0], "TODAY | \U0001F1F3\U0001F1F4 NORWAY\n---------\n\U0001F4FC Melodi Grand Prix\n\U0001F3C6 Final\n\U0001F553 19:50 CET\n---------\n\U0001F4FA https://nrk.no/mgp OR https://tv.nrk.no (geoblocked, account required: https://lyseurovision.github.io/help.html#account-Norway).")
